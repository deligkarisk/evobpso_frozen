...
class NeuralBooleanPSOParticle(Particle):
    ...
    def __init__(self, parent_pop, problem, decoder, pso_params: NeuralBPSOParams, velocity_strategy: NeuralBooleanPSOVelocityStrategy,
        ...
        if not isinstance(velocity_strategy, NeuralBooleanPSOVelocityStrategy):
            raise ValueError("Velocity update strategy in Neural BPSO must be " + str(NeuralBooleanPSOVelocityStrategy.__name__))
