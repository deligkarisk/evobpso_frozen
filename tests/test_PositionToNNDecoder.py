...
class TestPositionToNNDecoder(TestCase):
    def test_decode(self):
        ...
        filters_first_dim = 259  # binary is 258, then adding one as the minimum filter is one, not zero.
        ...
        position.append(0b011111100010010)
        filters_second_dim = 275  # binary is 274, then adding one as the minimum filter is one, not zero.
        ...
        position.append(0b100000000000011)
