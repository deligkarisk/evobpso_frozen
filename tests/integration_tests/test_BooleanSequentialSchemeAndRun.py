...
class BooleanSequentialSchemeAndRun(TestCase):

    def test_boolean_sequential_scheme_and_run(self):
        ...
        scheme = SequentialScheme(version='boolean', variable_length=True, vmax=False, vmut=True, optimization_params=optimization_params,
                                  encoding=encoding)
