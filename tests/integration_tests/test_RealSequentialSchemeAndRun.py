...
class TestRealSequentialSchemeAndRun(TestCase):
    ...
    def test_real_sequential_scheme_and_run(self):
        ...
        pso_params = RealPSOParams(pop_size=2, iters=2, c1=0.5, c2=0.5, k=1, mutation_prob=0, vmax=2, encoding=encoding)
        ...
        scheme = SequentialScheme(version='real', variable_length=True, vmax=False, vmut=True, optimization_params=optimization_params,
                                  encoding=encoding)
