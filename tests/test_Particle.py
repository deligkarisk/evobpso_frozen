...
class TestParticle(TestCase):
    ...
    def test_iterate(self):
        ...
        mock_evaluator.evaluate.return_value = 100, mock_evaluator_data
        ...
        mock_evaluator.evaluate.return_value = 51.5, mock_evaluator_data
        ...
        mock_evaluator.evaluate.return_value = 114.9, mock_evaluator_data
        old_position = particle.current_position
        particle.iterate(first_iter=False)
